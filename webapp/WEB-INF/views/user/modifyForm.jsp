...
<head>
<meta charset="UTF-8">
<title>mysite4 modifyForm</title>
				...
				<div id="user">
					<div id="modifyForm">
						<form action="" method="">
							...
							<!-- //나이 -->
							<div class="form-group">
								<span class="form-text">성별</span> <label for="rdo-male">남</label> <input type="radio" id="rdo-male" name="" value=""> <label for="rdo-female">여</label> <input type="radio" id="rdo-female" name="" value="">
